...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0013R.C0015id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0013R.C0015id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0013R.C0015id.touch_outside).setOnClickListener(new OnClickListener() {
