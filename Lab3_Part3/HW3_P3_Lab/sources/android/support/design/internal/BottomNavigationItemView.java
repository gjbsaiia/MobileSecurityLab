...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundResource(C0013R.C0014drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0013R.C0015id.icon);
        this.mSmallLabel = (TextView) findViewById(C0013R.C0015id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0013R.C0015id.largeLabel);
    }
