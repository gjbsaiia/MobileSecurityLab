...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo4172x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo4174y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo4176z(float value) {
        View view = (View) this.mView.get();
        if (view != null && VERSION.SDK_INT >= 21) {
