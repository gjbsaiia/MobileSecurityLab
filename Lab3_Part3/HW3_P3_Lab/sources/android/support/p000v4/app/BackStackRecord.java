...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    String mName;
    ArrayList<C0134Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0134Op {
        ...
        C0134Op(int cmd2, Fragment fragment2) {
            this.cmd = cmd2;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0134Op op = (C0134Op) this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
    ...
    private void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0134Op(opcmd, fragment));
    }
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0134Op thatOp = (C0134Op) record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0134Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0134Op removeOp = new C0134Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new C0134Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new C0134Op(9, oldPrimaryNav));
                    opNum++;
    ...
    public boolean isPostponed() {
        for (int opNum = 0; opNum < this.mOps.size(); opNum++) {
            if (isFragmentPostponed((C0134Op) this.mOps.get(opNum))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0134Op op) {
