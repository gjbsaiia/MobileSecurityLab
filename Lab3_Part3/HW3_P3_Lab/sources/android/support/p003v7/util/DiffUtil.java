    ...
    public static DiffResult calculateDiff(Callback cb, boolean detectMoves) {
        ...
        while (!arrayList.isEmpty()) {
            ...
            if (snake != null) {
                ...
                Range right = range;
                if (!snake.reverse) {
                    right.oldListStart = snake.f25x + snake.size;
                    right.newListStart = snake.f26y + snake.size;
                } else if (snake.removal) {
                    right.oldListStart = snake.f25x + snake.size + 1;
                    right.newListStart = snake.f26y + snake.size;
                } else {
                    right.oldListStart = snake.f25x + snake.size;
                    right.newListStart = snake.f26y + snake.size + 1;
                }
                arrayList.add(right);
            } else {
