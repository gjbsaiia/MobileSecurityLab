...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0329R.C0331id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0329R.C0331id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0329R.C0331id.action_bar));
        }
    }
